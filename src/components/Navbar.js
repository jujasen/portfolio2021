                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="menu__nav" class="navbar-nav ms-auto">
                            <li className="menu__item" class="nav-item">
                                <a className="menu__link" class="nav-link active" aria-current="page" href="#">Home</a>
                            </li>
                            <li className="menu__nav" class="nav-item">
                                <a className="menu__link" class="nav-link" href="#">Projects</a>
                            </li>
                            <li className="menu__nav" class="nav-item">
                                <a className="menu__link" class="nav-link" href="#">About</a>
                            </li>
                            <li className="menu__nav" class="nav-item">
                                <a className="menu__link" class="nav-link" href="#">Skills</a>
                            </li>
                            <li className="menu__nav" class="nav-item">
                                <a className="menu__link" class="nav-link" href="#">Contact</a>
                            </li>
                        </ul>
                     </div>
                </div>
