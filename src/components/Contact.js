        ...
        <>
            ...
            <section id="contact" className="contact">
                <div className="contact__desc">
                    ...
                    <p className="contact__text">
                        Get an in depth look at my work on <a href="https://github.com/jujasen" className="contact__link">github</a> 
                        {/* and <a href="https://www.behance.net/juliajakobsen" className="contact__link">behance</a> */}
                    </p>
                    <p className="contact__text">
